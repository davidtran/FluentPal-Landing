        ...
        <div className="bg-white shadow-[0_-4px_10px_rgba(0,0,0,0.1)] px-4 py-3">
          ...
          <div className="flex gap-2">
            <a
              ...
              className="flex-1 bg-blue-600 text-white py-3 px-4 rounded-xl font-medium text-center flex items-center justify-center gap-2 active:bg-blue-700"
            >
              <svg
                className="w-5 h-5"
                viewBox="0 0 24 24"
