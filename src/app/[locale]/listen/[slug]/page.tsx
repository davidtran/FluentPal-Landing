  ...
  return (    
    ...
    <div className="m-auto bg-[#032068] py-[10px] h-[100vh] flex flex-col">
      <div className="relative mx-auto max-w-[90%] w-[600px] flex-1 bg-white p-[20px] rounded-[20px] shadow-sm overflow-scroll">
        ...
        {error && <Center><div>{t('replay_not_found')}</div></Center>}
        {replay && !isStarted && (
          <Center>
            <div className='flex flex-col items-center'>            
            <div className='mb-[10px] font-bold'>{t('listening_to',  { username:replay.username})}</div>
            <div
        ...
        {replay && (
          ...
          >
            ...
            {isReplayEnded && (
              <div className='font-bold text-center pt-[10px] text-[#747474] underline text-[12px]'>{t('ended')}</div>
            )}
          </div>
        )}
      </div>
